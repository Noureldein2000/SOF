...
namespace SourceOfFund.Data.Migrations
{
    ...
    [Migration("20211229204918_AddIndexAndUniqueKeys")]
    partial class AddIndexAndUniqueKeys
    {
            ...
            modelBuilder.Entity("SourceOfFund.Data.Entities.AccountServiceAvailableBalance", b =>
                {
                    ...
                    b.HasIndex("AccountID", "BalanceTypeID")
                        .IsUnique()
                        .HasName("IX_AccountServiceAvailableBalances_AccountID_BalanceTypeID");
            ...
            modelBuilder.Entity("SourceOfFund.Data.Entities.AccountServiceBalance", b =>
                {
                    ...
                    b.HasIndex("AccountID", "BalanceTypeID")
                        .IsUnique()
                        .HasName("IX_AccountServiceBalances_AccountID_BalanceTypeID");
